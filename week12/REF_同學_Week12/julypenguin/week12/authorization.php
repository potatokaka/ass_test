        ...
        while ($row = $result->fetch_assoc()) {
          if ($row['classification'] !== 'super_admin') {
            echo "<section class='userinfo-box'>
                    ...
                    <div class='user-box'>
                      <div class='nickname-box'>暱稱：<div class='nickname'>" . escape($row['nickname']) . "</div>
                      <div class='username-box'> 帳號：<div class='username'>" . escape($row['username']) ."</div>
                      <div class='count-box'>留言數：<div class='count'>" . escape($row['content']) . "</div>
