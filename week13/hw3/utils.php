<?php
  ...
  function getNickname($conn, $user) {
			$sql = "SELECT * FROM potatokaka_users WHERE username = ?";
      $stmt = $conn->prepare($sql);
  ...
  function renderDeleteBtn($id) {
    ...
    // return "
    //   <div class='post__func'>
    //     <button class='btn'><a href='update_post.php?id=$id' data-id='$id'>Edit</a></button>
    //     <button class='btn'><a href='handle_delete_post.php?id=$id' data-id='$id'>Delete</a></button>
    //   </div>
    // ";
  }
